...
# Create a polynomial model function
y_pred = np.polyval(coefficients, x)

# Plotuj podatke i polinom koji se najbolje uklapa (best fit)
plt.plot(x, y, '.')
plt.plot(x, y_pred, 'b')

# Title with polynomial coefficients
plt.title(f'Polynomial Coefficients: {coefficients}')
